...
parser.add_argument('--model_path', default='train_results/model.ckpt', help='Model checkpoint path')
...
def predict():
    ...
    with tf.Session(config=config) as sess:
        ...
        batch_data = np.zeros([bacth_size, point_num, 3]).astype(np.float32)
