...
def conv(inputs, kernel_size, num_outputs, name,
        stride_size = [1, 1], padding = 'VALID', activation_fn = tf.nn.relu):
    """
...
def conv_btn(inputs, kernel_size, num_outputs, name,
        is_training = True, stride_size = [1, 1], padding = 'VALID', activation_fn = tf.nn.relu):
    """
...
def deconv_upsample(inputs, factor, name, padding = 'VALID', activation_fn = None):
    """
...
def maxpool(inputs, kernel_size, name, padding = 'VALID'):
    """
    Max pooling layer:
    ----------
    Args:
